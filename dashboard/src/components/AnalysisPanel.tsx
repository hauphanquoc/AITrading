...
export function AnalysisPanel({ timeframe }: AnalysisPanelProps) {
    ...
    <div className="space-y-4">
      ...
      {result && (
        <div className="bg-gray-800 rounded-xl border border-gray-700 overflow-hidden">
          ...
          {result.hasEntry && (
            <div className="grid grid-cols-3 gap-4 p-4 border-b border-gray-700 bg-gradient-to-r from-green-900/20 to-transparent">
              <div className="text-center">
                <div className="text-xs text-gray-400 mb-1">Entry</div>
                <div className="text-xl font-bold text-white">{result.entry?.toFixed(2) ?? '-'}</div>
              </div>
              <div className="text-center">
